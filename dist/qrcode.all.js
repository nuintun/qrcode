...
/***/ function(module, exports, __webpack_require__) {
	...
	var QRBase = exports.QRBase = {
	  ...
	  setFunctionalPattern: function setFunctionalPattern(qr) {
	    var x, y;
	    ...
	    function markAlignment(qr, qrbase) {
	      ...
	      for (i = 0; i < n; i++) {
	        for (j = 0; j < n; j++) {
	          ...
	          markSquare(qr, qrbase.alignmentPatterns[qr.version][i] - 2, qrbase.alignmentPatterns[qr.version][j] - 2, 5, 5);
	        }
	      }
	    }
	   ...
	   * 计算数据长度的编码字节数
	   */
	  nCountBits: function nCountBits(mode, version) {
	   ...
	   * 从版本计算二维码宽度
	   */
	  nModulesFromVersion: function nModulesFromVersion(version) {
	    return 17 + 4 * version;
	  },
	  /**
	   * UTF-8 和 Unicode 的相互转换
	   */
	  unicodeToUtf8: function unicodeToUtf8(string) {
	    var out = '';
	  ...
	  utf8Tounicode: function utf8Tounicode(string) {
	    var out = '';
	    var len = string.length;
	    var i = 0;
	  ...
	  versionInfo: [null, null, null, null, null, null, null, 0x07C94, 0x085BC, 0x09A99, 0x0A4D3, 0x0BBF6, 0x0C762, 0x0D847, 0x0E60D, 0x0F928, 0x10B78, 0x1145D, 0x12A17, 0x13532, 0x149A6, 0x15683, 0x168C9, 0x177EC, 0x18EC4, 0x191E1, 0x1AFAB, 0x1B08E, 0x1CC1A, 0x1D33F, 0x1ED75, 0x1F250, 0x209D5, 0x216F0, 0x228BA, 0x2379F, 0x24B0B, 0x2542E, 0x26A64, 0x27541, 0x28C69],
	  formatInfo: [0x5412, 0x5125, 0x5E7C, 0x5B4B, 0x45F9, 0x40CE, 0x4F97, 0x4AA0, 0x77C4, 0x72F3, 0x7DAA, 0x789D, 0x662F, 0x6318, 0x6C41, 0x6976, 0x1689, 0x13BE, 0x1CE7, 0x19D0, 0x0762, 0x0255, 0x0D0C, 0x083B, 0x355F, 0x3068, 0x3F31, 0x3A06, 0x24B4, 0x2183, 0x2EDA, 0x2BED],
	  /**
	   * 每个版本容纳的字节数
	   */
