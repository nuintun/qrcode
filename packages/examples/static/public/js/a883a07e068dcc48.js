 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e,t){let n=new Int32Array(e),r=e.length-t,i=new em().decode(n,r);return[n,i]}(e,t);u.set(n.subarray(0,t),s),l+=r,s+=t}return[u,l]}class ey{#eg;constructor({decode:e=er}={}){this.#eg=e}decode(e){let t,n,r,i=0,s=!1,l=new ef(e);try{t=l.readVersion(),r=l.readFormatInfo(),[n,i]=eb(l,t,r)}catch{null!=r&&l.remask(r.mask),l.mirror(),s=!0,t=l.readVersion(),r=l.readFormatInfo(),[n,i]=eb(l,t,r)}return new Y(function(e,t,n,r){let i,s,{}=n,l="",o=-1,w=!1,a=!1,u=!1,h=!1,f=new W(e);do switch(i=4>f.available()?ee.TERMINATOR:function(e){let t=X.get(e);if(null!=t)return t;throw Error("illegal mode bits")}(f.read(4))){case ee.TERMINATOR:break;case ee.FNC1_FIRST_POSITION:w=!0;break;case ee.FNC1_SECOND_POSITION:a=!0,o=f.read(8);break;case ee.STRUCTURED_APPEND:if(16>f.available())throw Error("illegal structured append");h=Object.freeze({index:f.read(4),parity:f.read(8),count:f.read(4)+1});break;case ee.ECI:s=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.0.0
