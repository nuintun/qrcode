 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class y{#E;#v;#A;#k;#O;#M;constructor(e,t){let n=0|t.x,r=0|t.y,i=0|e.x,s=0|e.y,o=Math.abs(r-s)>Math.abs(n-i);o&&([i,s,n,r]=[s,i,r,n]);let w=i<n?1:-1;this.#k=o,this.#A=n+w,this.#E=new l(n,r),this.#v=new l(i,s),this.#O=[w,s<r?1:-1],this.#M=[Math.abs(n-i),Math.abs(r-s)]}*points(){let e=this.#A,t=this.#k,{y:n}=this.#E,[r,i]=this.#O,[s,o]=this.#M,{x:l,y:w}=this.#v,a=0|-s/2;for(let u=l,h=w;u!==e;u+=r)if(yield[t?h:u,t?u:h],(a+=o)>0){if(h===n)break;h+=i,a-=s}}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.0.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function p(e,t,n){let r=0,{width:i,height:s}=e,o=new l((t.x+n.x)/2,(t.y+n.y)/2);for(let[n,a]of new y(t,o).points()){if(n<0||a<0||n>=i||a>=s){if(2===r)return w(t,new l(n,a));break}if(1===r==(1===e.get(n,a))){if(2===r)return w(t,new l(n,a));r++}}return NaN}function x(e,t,n){let r=p(e,t,n);if(Number.isNaN(r))return NaN;let{x:i,y:s}=n,{x:o,y:w}=t,a=p(e,t,new l(o-(i-o),w-(s-w)));return Number.isNaN(a)?NaN:r+a-1}function z(e,t,n){let r=new l(0|t.x,0|t.y),i=new l(0|n.x,0|n.y),s=x(e,r,i),o=x(e,i,r);return Number.isNaN(s)?o/7:Number.isNaN(o)?s/7:(s+o)/14}function I(e,t){var n,r,i,s;let o=Math.max((n=h.width(e))>(r=h.width(t))?n/r:r/n,(i=h.height(e))>(s=h.height(t))?i/s:s/i);return o*o}class C{#N;#I;#c;#T;#a;#_;#R;static area(e){let[t,n,r]=e.#_,i=C.bottomRight(e);if(null==e.#N){let s=u(t,n,i),o=u(i,r,t);e.#N=s+o}return e.#N}static moduleSizes(e){if(null==e.#R){let t=e.#c,[n,r,i]=e.#_;e.#R=[z(t,n,r),z(t,n,i)]}return e.#R}static size(t){if(null==t.#I){let n=C.moduleSize(t);t.#I=function(t,n){let[r,i,s]=t,o=e((w(r,i)+w(r,s))/n/2)+7;switch(3&o){case 0:return o+1;case 2:return o-1;case 3:return Math.min(o+2,177)}return o}(t.#_,n)}return t.#I}static moduleSize(e){return null==e.#a&&(e.#a=n(C.moduleSizes(e))/2),e.#a}static contains(e,t){let n=C.area(e),[r,i,s]=e.#_,o=C.bottomRight(e),l=u(r,i,t);return l+u(i,o,t)+u(o,s,t)+u(s,r,t)-n<1}static bottomRight(e){return null==e.#T&&(e.#T=function(e){let[t,n,r]=e,{x:i,y:s}=t;return new l(n.x+r.x-i,n.y+r.y-s)}(e.#_)),e.#T}constructor(e,t){this.#c=e,this.#_=function(e){let t,n,r;let[i,s,o]=e,l=a(i,s)*I(i,s),w=a(i,o)*I(i,o),u=a(s,o)*I(s,o);return u>=l&&u>=w?[t,r,n]=e:w>=u&&w>=l?[r,t,n]=e:[r,n,t]=e,0>function(e,t,n){let{x:r,y:i}=t;return(n.x-r)*(e.y-i)-(n.y-i)*(e.x-r)}(r,t,n)&&([r,n]=[n,r]),[t,n,r]}(t)}get topLeft(){return this.#_[0]}get topRight(){return this.#_[1]}get bottomLeft(){return this.#_[2]}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.0.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e){let{x:t,y:n}=e.topLeft,r=1-3/(C.size(e)-7),i=C.bottomRight(e),[s,o]=C.moduleSizes(e);return new h(P,t+(i.x-t)*r,n+(i.y-n)*r,5*s,5*o,0)}(t),s=new Q(e,n),o=C.moduleSize(t),{x:l,y:w}=i,a=Math.ceil(o*Math.min(20,0|r/4)),u=0|Math.max(0,w-a),f=0|Math.max(0,l-a),c=0|Math.min(e.width-1,l+a),d=0|Math.min(e.height-1,w+a);return s.find(f,u,c-f,d-u),s.filter(i,o)}(e,r,t)){let t=A(r,s);if(_(e,t,i)&&_(e,t,i,!0)&&(n=yield new S(e,t,r,s)))break}else{let t=A(r);_(e,t,i)&&_(e,t,i,!0)&&(n=yield new S(e,t,r))}o=s.next(n)}}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.0.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e,t){let n=new Int32Array(e),r=e.length-t,i=new em().decode(n,r);return[n,i]}(e,t);a.set(n.subarray(0,t),s),o+=r,s+=t}return[a,o]}class ey{#eg;constructor({decode:e=er}={}){this.#eg=e}decode(e){let t,n,r,i=0,s=!1,o=new ef(e);try{t=o.readVersion(),r=o.readFormatInfo(),[n,i]=eb(o,t,r)}catch{null!=r&&o.remask(r.mask),o.mirror(),s=!0,t=o.readVersion(),r=o.readFormatInfo(),[n,i]=eb(o,t,r)}return new Y(function(e,t,n){let r,i,s,o="",l=-1,w=!1,a=!1,u=!1,h=!1,f=new W(e);do switch(i=4>f.available()?ee.TERMINATOR:function(e){let t=X.get(e);if(null!=t)return t;throw Error("illegal mode bits")}(f.read(4))){case ee.TERMINATOR:break;case ee.FNC1_FIRST_POSITION:w=!0;break;case ee.FNC1_SECOND_POSITION:a=!0,l=f.read(8);break;case ee.STRUCTURED_APPEND:if(16>f.available())throw Error("illegal structured append");h=Object.freeze({index:f.read(4),count:f.read(4)+1,parity:f.read(8)});break;case ee.ECI:s=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.0.0
