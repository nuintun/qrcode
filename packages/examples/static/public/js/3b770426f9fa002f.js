 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class y{#E;#v;#A;#k;#M;#O;constructor(e,t){let n=0|t.x,r=0|t.y,i=0|e.x,s=0|e.y,o=Math.abs(r-s)>Math.abs(n-i);o&&([i,s,n,r]=[s,i,r,n]);let l=i<n?1:-1;this.#k=o,this.#A=n+l,this.#E=new w(n,r),this.#v=new w(i,s),this.#M=[l,s<r?1:-1],this.#O=[Math.abs(n-i),Math.abs(r-s)]}*points(){let e=this.#A,t=this.#k,{y:n}=this.#E,[r,i]=this.#M,[s,o]=this.#O,{x:w,y:l}=this.#v,a=0|-s/2;for(let f=w,u=l;f!==e;f+=r)if(yield[t?u:f,t?f:u],(a+=o)>0){if(u===n)break;u+=i,a-=s}}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class S{#w;#D;#P;#l;constructor(e,t,n,r){let i=new u(e,t),s=C.size(n);this.#w=e,this.#l=t,this.#P=n,this.#D=r,this.#w=i.sample(s,s)}get matrix(){return this.#w}get finder(){return this.#P}get alignment(){return this.#D}get size(){return C.size(this.#P)}get moduleSize(){return C.moduleSize(this.#P)}mapping(e,t){return[e,t]=this.#l.mapping(e,t),new w(e,t)}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e,t){let{ratios:r,modules:i}=t,s=0,{length:o}=r,w=n(e),l=w/i;for(let t=0;t<o;t++)s+=Math.abs(e[t]-r[t]*l);return[s/w,l]}(t,e);s+=r,l.push(i)}let a=n(l),f=a/w;for(let e of l)o+=Math.abs(e-f);return s+o/a}(o,e,a,t,r),s=n(e),f=n(a),u=this.#_,{length:c}=u,d=!1;for(let e=0;e<c;e++){let t=u[e];if(t.equals(w,l,s,f)){d=!0,u[e]=t.combine(w,l,s,f,i);break}}d||u.push(new h(o,w,l,s,f,i))}}}}}class K extends J{constructor(e,t){super(e,D,t)}*groups(){let t=this.patterns.filter(e=>h.combined(e)>=3&&1.5>=h.noise(e)),{length:n}=t;if(3===n){let e=new C(this.matrix,t),n=C.size(e);n>=21&&n<=177&&(yield e)}else if(n>3){let r=n-2,i=n-1,s=new Map;for(let o=0;o<r;o++){let r=t[o],w=r.moduleSize;if(!s.has(r))for(let a=o+1;a<i;a++){let i=t[a],o=i.moduleSize;if(s.has(r))break;if(!s.has(i)&&q(w,o,.5))for(let f=a+1;f<n;f++){let n=t[f],a=n.moduleSize;if(s.has(r)||s.has(i))break;if(!q(w,a,.5)||!q(o,a,.5))continue;let{matrix:u}=this,c=new C(u,[r,i,n]),d=function(e){let{topLeft:t,topRight:n,bottomLeft:r}=e,{x:i,y:s}=t,o=n.x-i,w=n.y-s,l=r.x-i,a=r.y-s;return Math.acos((o*l+w*a)/Math.sqrt((o*o+w*w)*(l*l+a*a)))}(c);if(d>=H&&d<=$){let[o,w]=C.moduleSizes(c);if(o>=1&&w>=1){let{topLeft:a,topRight:f,bottomLeft:d}=c,g=l(a,f),m=l(a,d),b=e(g/o),y=e(m/w);if(4>=Math.abs(b-y)){let e=C.size(c);e>=21&&e<=177&&!/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e){let{x:t,y:n}=e.topLeft,r=C.size(e),i=1-3/(r-7),s=C.bottomRight(e),[o,w]=C.moduleSizes(e),l=t+(s.x-t)*i,a=n+(s.y-n)*i;return new h(P,l,a,5*o,5*w,0)}(t),o=new Q(e,n),w=C.moduleSize(t),{x:l,y:a}=s,f=Math.ceil(w*i),u=0|Math.max(0,a-f),c=0|Math.max(0,l-f),d=0|Math.min(e.width-1,l+f),g=0|Math.min(e.height-1,a+f);return o.find(c,u,d-c,g-u),o.filter(s,w)}(e,r,t);for(let t of s){let s=A(r,t);if(_(e,s,i)&&_(e,s,i,!0)&&(n=yield new S(e,s,r,t)))break}}else{let t=A(r);_(e,t,i)&&_(e,t,i,!0)&&(n=yield new S(e,t,r))}o=s.next(n)}}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
