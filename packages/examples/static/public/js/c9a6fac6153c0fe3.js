 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e){let t=u.get(e);return null!=t?t:NaN}(t);if(n>=41377&&n<=43774)n-=41377;else if(n>=45217&&n<=64254)n-=42657;else throw Error(`illegal hanzi character: ${t}`);n=(n>>8)*96+(255&n),e.append(n,13)}return e}}class _{#s;constructor(e){l(e),this.#s=e}get mode(){return t.KANJI}get content(){return this.#s}encode(){let e=new i;for(let t of this.#s){let n=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class H{#C;#_;constructor(e,t){let{length:n}=t;if(n<=0)throw Error("polynomial coefficients cannot empty");if(this.#C=e,n>1&&0===t[0]){let e=1;for(;e<n&&0===t[e];)e++;if(e===n)this.#_=new Int32Array([0]);else{let r=new Int32Array(n-e);r.set(t.subarray(e)),this.#_=r}}else this.#_=t}get coefficients(){return this.#_}isZero(){return 0===this.#_[0]}getDegree(){return this.#_.length-1}getCoefficient(e){let t=this.#_;return t[t.length-1-e]}evaluate(e){let t;if(0===e)return this.getCoefficient(0);let n=this.#_;if(1===e){for(let e of(t=0,n))t^=e;return t}[t]=n;let r=this.#C,{length:w}=n;for(let i=1;i<w;i++)t=r.multiply(e,t)^n[i];return t}multiply(e){let t=this.#C,n=this.#_,{length:r}=n;if(e instanceof H){if(this.isZero()||e.isZero())return t.zero;let w=e.#_,i=w.length,s=new Int32Array(r+i-1);for(let e=0;e<r;e++){let r=n[e];for(let n=0;n<i;n++)s[e+n]^=t.multiply(r,w[n])}return new H(t,s)}if(0===e)return t.zero;if(1===e)return this;let w=new Int32Array(r);for(let i=0;i<r;i++)w[i]=t.multiply(n[i],e);return new H(t,w)}multiplyByMonomial(e,t){let n=this.#C;if(0===t)return n.zero;let r=this.#_,{length:w}=r,i=new Int32Array(w+e);for(let e=0;e<w;e++)i[e]=n.multiply(r[e],t);return new H(n,i)}addOrSubtract(e){if(this.isZero())return e;if(e.isZero())return this;let t=e.#_,n=t.length,r=this.#_,w=r.length;n<w&&([n,w]=[w,n],[t,r]=[r,t]);let i=n-w,s=new Int32Array(n);s.set(t.subarray(0,i));for(let e=i;e<n;e++)s[e]=r[e-i]^t[e];return new H(this.#C,s)}divide(e){let t=this.#C,n=t.zero,r=this,w=e.getCoefficient(e.getDegree()),i=t.invert(w);for(;r.getDegree()>=e.getDegree()&&!r.isZero();){let w=r.getDegree(),s=w-e.getDegree(),o=t.multiply(r.getCoefficient(w),i),l=e.multiplyByMonomial(s,o),a=t.buildPolynomial(s,o);n=n.addOrSubtract(a),r=r.addOrSubtract(l)}return[n,r]}}let Z=new /**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class{#l;#A;#E;#B;#S;#v;constructor(e,t,n){let r=1,w=new Int32Array(t);for(let n=0;n<t;n++)w[n]=r,(r*=2)>=t&&(r^=e,r&=t-1);let i=new Int32Array(t);for(let e=0,n=t-1;e<n;e++)i[w[e]]=e;this.#l=t,this.#S=w,this.#v=i,this.#B=n,this.#A=new H(this,new Int32Array([1])),this.#E=new H(this,new Int32Array([0]))}get size(){return this.#l}get one(){return this.#A}get zero(){return this.#E}get generator(){return this.#B}exp(e){return this.#S[e]}log(e){return this.#v[e]}invert(e){return this.#S[this.#l-this.#v[e]-1]}multiply(e,t){if(0===e||0===t)return 0;let n=this.#v;return this.#S[(n[e]+n[t])%(this.#l-1)]}buildPolynomial(e,t){if(0===t)return this.#E;let n=new Int32Array(e+1);return n[0]=t,new H(this,n)}}(285,256,0);class G{#C;#T;constructor(e=Z){this.#C=e,this.#T=[new H(e,new Int32Array([1]))]}encode(e,t){let n=e.length-t,r=new Int32Array(n),w=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
