 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class W{#K;#Q;#W;#E;#X;#ee;constructor(e,t,{mask:n,level:r},i,s){this.#K=n,this.#Q=r,this.#W=s,this.#E=t,this.#ee=e,this.#X=i}get mask(){return this.#K}get level(){return this.#Q.name}get version(){return this.#E.version}get mirror(){return this.#W}get content(){return this.#ee.content}get corrected(){return this.#X}get symbology(){return this.#ee.symbology}get fnc1(){return this.#ee.fnc1}get codewords(){return this.#ee.codewords}get structured(){return this.#ee.structured}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
