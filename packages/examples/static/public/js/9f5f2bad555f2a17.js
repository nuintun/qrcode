 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class y{#E;#A;#k;#v;#O;#M;constructor(e,t){let n=0|t.x,r=0|t.y,i=0|e.x,s=0|e.y,o=Math.abs(r-s)>Math.abs(n-i);o&&([i,s,n,r]=[s,i,r,n]);let l=i<n?1:-1;this.#v=o,this.#k=n+l,this.#E=new w(n,r),this.#A=new w(i,s),this.#O=[l,s<r?1:-1],this.#M=[Math.abs(n-i),Math.abs(r-s)]}*points(){let e=this.#k,t=this.#v,{y:n}=this.#E,[r,i]=this.#O,[s,o]=this.#M,{x:w,y:l}=this.#A,a=0|-s/2;for(let u=w,f=l;u!==e;u+=r)if(yield[t?f:u,t?u:f],(a+=o)>0){if(f===n)break;f+=i,a-=s}}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function p(e,t,n){let r=0,{width:i,height:s}=e,o=(t.x+n.x)/2,a=(t.y+n.y)/2,u=new w(o,a),f=new y(t,u).points();for(let[n,o]of f){if(n<0||o<0||n>=i||o>=s){if(2===r)return l(t,new w(n,o));break}if(1===r==(1===e.get(n,o))){if(2===r)return l(t,new w(n,o));r++}}return NaN}function x(e,t,n){let r=p(e,t,n);if(Number.isNaN(r))return NaN;let{x:i,y:s}=n,{x:o,y:l}=t,a=p(e,t,new w(o-(i-o),l-(s-l)));return Number.isNaN(a)?NaN:r+a-1}function z(e,t,n){let r=new w(0|t.x,0|t.y),i=new w(0|n.x,0|n.y),s=x(e,r,i),o=x(e,i,r);return Number.isNaN(s)?o/7:Number.isNaN(o)?s/7:(s+o)/14}function I(e,t){var n,r,i,s;let o=Math.max((n=f.width(e))>(r=f.width(t))?n/r:r/n,(i=f.height(e))>(s=f.height(t))?i/s:s/i);return o*o}class C{#N;#I;#c;#T;#a;#_;#R;static area(e){let[t,n,r]=e.#_,i=C.bottomRight(e);if(null==e.#N){let s=u(t,n,i),o=u(i,r,t);e.#N=s+o}return e.#N}static moduleSizes(e){if(null==e.#R){let t=e.#c,[n,r,i]=e.#_;e.#R=[z(t,n,r),z(t,n,i)]}return e.#R}static size(t){if(null==t.#I){let n=C.moduleSize(t);t.#I=function(t,n){let[r,i,s]=t,o=l(r,i),w=l(r,s),a=e((o+w)/n/2)+7;switch(3&a){case 0:return a+1;case 2:return a-1;case 3:return Math.min(a+2,177)}return a}(t.#_,n)}return t.#I}static moduleSize(e){return null==e.#a&&(e.#a=n(C.moduleSizes(e))/2),e.#a}static contains(e,t){let n=C.area(e),[r,i,s]=e.#_,o=C.bottomRight(e),w=u(r,i,t),l=u(i,o,t),a=u(o,s,t),f=u(s,r,t);return w+l+a+f-n<1}static bottomRight(e){return null==e.#T&&(e.#T=function(e){let[t,n,r]=e,{x:i,y:s}=t,o=n.x+r.x-i,l=n.y+r.y-s;return new w(o,l)}(e.#_)),e.#T}constructor(e,t){this.#c=e,this.#_=function(e){let t,n,r;let[i,s,o]=e,w=a(i,s)*I(i,s),l=a(i,o)*I(i,o),u=a(s,o)*I(s,o);return u>=w&&u>=l?[t,r,n]=e:l>=u&&l>=w?[r,t,n]=e:[r,n,t]=e,0>function(e,t,n){let{x:r,y:i}=t;return(n.x-r)*(e.y-i)-(n.y-i)*(e.x-r)}(r,t,n)&&([r,n]=[n,r]),[t,n,r]}(t)}get topLeft(){return this.#_[0]}get topRight(){return this.#_[1]}get bottomLeft(){return this.#_[2]}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class E{#B;#U;#F;#Z;#L;#H;#j;#$;#q;constructor(e,t,n,r,i,s,o,w,l){this.#B=e,this.#U=r,this.#F=o,this.#Z=t,this.#L=i,this.#H=w,this.#j=n,this.#$=s,this.#q=l}buildAdjoint(){let e=this.#B,t=this.#U,n=this.#F,r=this.#Z,i=this.#L,s=this.#H,o=this.#j,w=this.#$,l=this.#q;return new E(i*l-s*w,s*o-r*l,r*w-i*o,n*w-t*l,e*l-n*o,t*o-e*w,t*s-n*i,n*r-e*s,e*i-t*r)}times(e){let t=this.#B,n=this.#U,r=this.#F,i=this.#Z,s=this.#L,o=this.#H,w=this.#j,l=this.#$,a=this.#q,u=e.#B,f=e.#U,h=e.#F,c=e.#Z,d=e.#L,g=e.#H,m=e.#j,b=e.#$,y=e.#q;return new E(t*u+i*f+w*h,t*c+i*d+w*g,t*m+i*b+w*y,n*u+s*f+l*h,n*c+s*d+l*g,n*m+s*b+l*y,r*u+o*f+a*h,r*c+o*d+a*g,r*m+o*b+a*y)}mapping(e,t){let n=this.#B,r=this.#U,i=this.#F,s=this.#Z,o=this.#L,w=this.#H,l=this.#j,a=this.#$,u=this.#q,f=i*e+w*t+u;return[(n*e+s*t+l)/f,(r*e+o*t+a)/f]}}function A(e,t,n,r,i,s,o,w){let l=e-n+i-o,a=t-r+s-w;if(0===l&&0===a)return new E(n-e,i-n,e,r-t,s-r,t,0,0,1);{let u=n-i,f=o-i,h=r-s,c=w-s,d=u*c-f*h,g=(l*c-f*a)/d,m=(u*a-l*h)/d;return new E(n-e+g*n,o-e+m*o,e,r-t+g*r,w-t+m*w,t,g,m,1)}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function k(e,t){let n,r,i,s;let{x:o,y:w}=e.topLeft,{x:l,y:a}=e.topRight,{x:u,y:f}=e.bottomLeft,h=C.size(e)-3.5;return null!=t?(n=t.x,r=t.y,s=i=h-3):(n=l+u-o,r=a+f-w,i=h,s=h),function(e,t,n,r,i,s,o,w,l,a,u,f,h,c,d,g){let m=A(3.5,3.5,n,3.5,i,s,3.5,w).buildAdjoint(),b=A(l,a,u,f,h,c,d,g);return b.times(m)}(0,0,h,0,i,s,0,h,o,w,l,a,n,r,u,f)}function v(e,t){let[n,,r]=f.rect(e);return t>0?r:t<0?n:e.x}function O(e,t){let[,n,,r]=f.rect(e);return t>0?r:t<0?n:e.y}function M(e,t,n,r){let{x:i,y:s}=t,{x:o,y:l}=e,{x:a,y:u}=n,f=a>i?1:a<i?-1:0,h=u>s?1:u<s?-1:0,c=v(t,f),d=O(t,h),g=v(e,f),m=O(e,h);return 0===f||0===h?[new w(g,m),new w(c,d)]:(r?f===h:f!==h)?[new w(o,m),new w(i,d)]:[new w(g,l),new w(c,s)]}function N(e,t,n,r){let i=r+8,s=new y(t,n).points(),o=1,w=e.get(0|t.x,0|t.y);for(let[t,n]of s){let r=e.get(t,n);if(r!==w&&(o++,w=r,o>i))return!1}return o>=r-14-Math.max(2,(r-17)/4)}function T(e,t,n){let{topLeft:r,topRight:i,bottomLeft:s}=t,[o,w]=n?M(r,s,i,!0):M(r,i,s);return N(e,o,w,C.size(t))}function _(e,t,n,r){let[i,s]=t.mapping(r?6.5:7.5,r?7.5:6.5),[o,l]=t.mapping(r?6.5:n-7.5,r?n-7.5:6.5);return N(e,new w(i,s),new w(o,l),n)}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class J{#J;#c;#f;#_=[];constructor(e,t,n){this.#c=e,this.#f=t,this.#J=n}get matrix(){return this.#c}get patterns(){return this.#_}match(e,t,r,i){let s=this.#c,o=this.#f,w=Z(r,e),[l,a]=$(s,w,t,i,o,!0);if(l>=0){let e;if([w,e]=$(s,w,l,i,o),w>=0){let t=F(s,w,l,i),r=F(s,w,l,i,!0);if(this.#J?G(t,o)&&G(r,o):G(t,o)||G(r,o)){let i=function(e){for(var t=arguments.length,r=Array(t>1?t-1:0),i=1;i<t;i++)r[i-1]=arguments[i];let s=0,o=0,{length:w}=r,l=[];for(let t of r){let[r,i]=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e,t){let{ratios:r,modules:i}=t,s=0,{length:o}=r,w=n(e),l=w/i;for(let t=0;t<o;t++)s+=Math.abs(e[t]-r[t]*l);return[s/w,l]}(t,e);s+=r,l.push(i)}let a=n(l),u=a/w;for(let e of l)o+=Math.abs(e-u);return s+o/a}(o,e,a,t,r),s=n(e),u=n(a),h=this.#_,{length:c}=h,d=!1;for(let e=0;e<c;e++){let t=h[e];if(f.equals(t,w,l,s,u)){d=!0,h[e]=f.combine(t,w,l,s,u,i);break}}d||h.push(new f(o,w,l,s,u,i))}}}}}class K extends J{constructor(e,t){super(e,D,t)}*groups(){let t=this.patterns.filter(e=>f.combined(e)>=3&&1.5>=f.noise(e)),{length:n}=t;if(3===n){let e=new C(this.matrix,t),n=C.size(e);n>=21&&n<=177&&(yield e)}else if(n>3){let r=n-2,i=n-1,s=new Map;for(let o=0;o<r;o++){let r=t[o],w=r.moduleSize;if(!s.has(r))for(let a=o+1;a<i;a++){let i=t[a],o=i.moduleSize;if(s.has(r))break;if(!s.has(i)&&q(w,o,.5))for(let u=a+1;u<n;u++){let n=t[u],a=n.moduleSize;if(s.has(r)||s.has(i))break;if(!q(w,a,.5)||!q(o,a,.5))continue;let{matrix:h}=this,c=new C(h,[r,i,n]),d=function(e){let{topLeft:t,topRight:n,bottomLeft:r}=e,{x:i,y:s}=t,o=n.x-i,w=n.y-s,l=r.x-i,a=r.y-s;return Math.acos((o*l+w*a)/Math.sqrt((o*o+w*w)*(l*l+a*a)))}(c);if(d>=H&&d<=j){let[o,w]=C.moduleSizes(c);if(o>=1&&w>=1){let{topLeft:a,topRight:u,bottomLeft:d}=c,g=l(a,u),m=l(a,d),b=e(g/o),y=e(m/w);if(4>=Math.abs(b-y)){let e=C.size(c);e>=21&&e<=177&&!/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function ef(e,t,n,r){return e.get(t,n)?r<<1|1:r<<1}class eh{#I;#c;constructor(e){let{width:t,height:n}=e;this.#c=e.clone(),this.#I=Math.min(t,n)}readVersion(){let e=this.#I,n=0|(e-17)/4;if(n<1)throw Error("");if(n<=6)return b[n-1];let r=0,i=0,s=e-11,o=this.#c;for(let t=5;t>=0;t--)for(let n=e-9;n>=s;n--)r=ef(o,n,t,r);for(let t=5;t>=0;t--)for(let n=e-9;n>=s;n--)i=ef(o,t,n,i);let w=function(e,n){let r=32,i=0,{length:s}=g;for(let o=0;o<s;o++){let s=g[o];if(e===s||n===s)return b[o+6];let w=t(e^s);w<r&&(r=w,i=o+7),e!==n&&(w=t(n^s))<r&&(r=w,i=o+7)}if(r<=3&&i>=7)return b[i-1];throw Error("unable to decode version")}(r,i);if(w.size>e)throw Error("");return w}readFormatInfo(){let e=0,n=0,r=this.#c,i=this.#I,s=i-7;for(let t=0;t<=8;t++)6!==t&&(e=ef(r,t,8,e));for(let t=7;t>=0;t--)6!==t&&(e=ef(r,8,t,e));for(let e=i-1;e>=s;e--)n=ef(r,8,e,n);for(let e=i-8;e<i;e++)n=ef(r,e,8,n);return function(e,n){let r=32,i=0;for(let[s,o]of ea){if(e===s||n===s)return new eu(o);let w=t(e^s);w<r&&(r=w,i=o),e!==n&&(w=t(n^s))<r&&(r=w,i=o)}if(r<=3)return new eu(i);throw Error("unable to decode format information")}(e,n)}readCodewords(e,t){let n=0,i=0,s=0,o=!0,w=this.#I,l=this.#c,a=e.getECBlocks(t),u=function(e){let{size:t,version:n,alignmentPatterns:i}=e,{length:s}=i,o=new r(t,t),w=s-1;o.setRegion(0,0,9,9),o.setRegion(t-8,0,8,9),o.setRegion(0,t-8,9,8);for(let e=0;e<s;e++){let t=i[e]-2;for(let n=0;n<s;n++)(0!==e||0!==n&&n!==w)&&(e!==w||0!==n)&&o.setRegion(i[n]-2,t,5,5)}return o.setRegion(6,9,1,t-17),o.setRegion(9,6,t-17,1),n>6&&(o.setRegion(t-11,0,3,6),o.setRegion(0,t-11,6,3)),o}(e),f=new Uint8Array(a.numTotalCodewords);for(let e=w-1;e>0;e-=2){6===e&&e--;for(let t=0;t<w;t++){let r=o?w-1-t:t;for(let t=0;t<2;t++){let o=e-t;u.get(o,r)||(n++,s<<=1,l.get(o,r)&&(s|=1),8!==n||(f[i++]=s,n=0,s=0))}}o=!o}if(i!==a.numTotalCodewords)throw Error("byteOffset !== ecBlocks.numTotalCodewords");return f}unmask(e){let t=this.#I,n=this.#c;for(let r=0;r<t;r++)for(let i=0;i<t;i++)(function(e,t,n){let r,i;switch(e){case 0:i=n+t&1;break;case 1:i=1&n;break;case 2:i=t%3;break;case 3:i=(n+t)%3;break;case 4:i=(0|n/2)+(0|t/3)&1;break;case 5:i=(1&(r=n*t))+r%3;break;case 6:i=(1&(r=n*t))+r%3&1;break;case 7:i=n*t%3+(n+t&1)&1;break;default:throw Error(`illegal mask: ${e}`)}return 0===i})(e,i,r)&&n.flip(i,r)}remask(e){this.unmask(e)}mirror(){let e=this.#I,t=this.#c;for(let n=0;n<e;n++)for(let r=n+1;r<e;r++)t.get(n,r)!==t.get(r,n)&&(t.flip(n,r),t.flip(r,n))}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class{#I;#eu;#ef;#eh;#ec;#ed;constructor(e,t,n){let r=1,i=new Int32Array(t);for(let n=0;n<t;n++)i[n]=r,(r*=2)>=t&&(r^=e,r&=t-1);let s=new Int32Array(t);for(let e=0,n=t-1;e<n;e++)s[i[e]]=e;this.#I=t,this.#ec=i,this.#ed=s,this.#eh=n,this.#eu=new ed(this,new Int32Array([1])),this.#ef=new ed(this,new Int32Array([0]))}get size(){return this.#I}get one(){return this.#eu}get zero(){return this.#ef}get generator(){return this.#eh}exp(e){return this.#ec[e]}log(e){return this.#ed[e]}invert(e){return this.#ec[this.#I-this.#ed[e]-1]}multiply(e,t){if(0===e||0===t)return 0;let n=this.#ed;return this.#ec[(n[e]+n[t])%(this.#I-1)]}buildPolynomial(e,t){if(0===t)return this.#ef;let n=new Int32Array(e+1);return n[0]=t,new ed(this,n)}}(285,256,0);class em{#el;constructor(e=eg){this.#el=e}decode(e,t){let n=!0,r=this.#el,{generator:i}=r,s=new ed(r,e),o=new Int32Array(t);for(let e=0;e<t;e++){let w=s.evaluate(r.exp(e+i));o[t-1-e]=w,0!==w&&(n=!1)}if(!n){let n=new ed(r,o),[i,s]=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
