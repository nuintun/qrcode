 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class _{#s;#o;constructor(e,t=o.ISO_8859_1){l(e),function(e){if(!(e instanceof o))throw Error("illegal charset")}(t),this.#s=e,this.#o=t}get mode(){return t.BYTE}get content(){return this.#s}get charset(){return this.#o}encode(e){let t=new i;for(let n of e(this.#s,this.#o))t.append(n,8);return t}}function B(e,t,n){return 1===e.get(t,n)}function E(e,t){let n=0,{size:r}=e;for(let w=0;w<r;w++){let i=-1,s=0;for(let o=0;o<r;o++){let r=t?e.get(w,o):e.get(o,w);r===i?s++:(s>=5&&(n+=3+(s-5)),i=r,s=1)}s>=5&&(n+=3+(s-5))}return n}function S(e,t,n,r,w){if(n<0||r>e.size)return!1;for(let i=n;i<r;i++)if(w?B(e,t,i):B(e,i,t))return!1;return!0}function T(e){return E(e)+E(e,!0)+function(e){let t=0,n=e.size-1;for(let r=0;r<n;r++)for(let w=0;w<n;w++){let n=e.get(w,r);n===e.get(w+1,r)&&n===e.get(w,r+1)&&n===e.get(w+1,r+1)&&(t+=3)}return t}(e)+function(e){let t=0,{size:n}=e;for(let r=0;r<n;r++)for(let w=0;w<n;w++)w+6<n&&B(e,w,r)&&!B(e,w+1,r)&&B(e,w+2,r)&&B(e,w+3,r)&&B(e,w+4,r)&&!B(e,w+5,r)&&B(e,w+6,r)&&(S(e,r,w-4,w)||S(e,r,w+7,w+11))&&t++,r+6<n&&B(e,w,r)&&!B(e,w,r+1)&&B(e,w,r+2)&&B(e,w,r+3)&&B(e,w,r+4)&&!B(e,w,r+5)&&B(e,w,r+6)&&(S(e,w,r-4,r,!0)||S(e,w,r+7,r+11,!0))&&t++;return 40*t}(e)+function(e){let t=0,{size:n}=e;for(let r=0;r<n;r++)for(let w=0;w<n;w++)B(e,w,r)&&t++;let r=n*n;return(0|10*Math.abs(2*t-r)/r)*10}(e)}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class v{#l;#a;constructor(e){this.#l=e,this.#a=new Int8Array(e*e)}get size(){return this.#l}set(e,t,n){this.#a[t*this.#l+e]=n}get(e,t){return this.#a[t*this.#l+e]}clear(e){this.#a.fill(e)}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class{#l;#_;#B;#E;#S;#T;constructor(e,t,n){let r=1,w=new Int32Array(t);for(let n=0;n<t;n++)w[n]=r,(r*=2)>=t&&(r^=e,r&=t-1);let i=new Int32Array(t);for(let e=0,n=t-1;e<n;e++)i[w[e]]=e;this.#l=t,this.#S=w,this.#T=i,this.#E=n,this.#_=new H(this,new Int32Array([1])),this.#B=new H(this,new Int32Array([0]))}get size(){return this.#l}get one(){return this.#_}get zero(){return this.#B}get generator(){return this.#E}exp(e){return this.#S[e]}log(e){return this.#T[e]}invert(e){return this.#S[this.#l-this.#T[e]-1]}multiply(e,t){if(0===e||0===t)return 0;let n=this.#T;return this.#S[(n[e]+n[t])%(this.#l-1)]}buildPolynomial(e,t){if(0===t)return this.#B;let n=new Int32Array(e+1);return n[0]=t,new H(this,n)}}(285,256,0);class G{#C;#v;constructor(e=Z){this.#C=e,this.#v=[new H(e,new Int32Array([1]))]}encode(e,t){let n=e.length-t,r=new Int32Array(n),w=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
