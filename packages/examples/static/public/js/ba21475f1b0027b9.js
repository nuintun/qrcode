 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class S{#P;#U;#F;#L;#Z;#H;#j;#$;#q;constructor(e,t,n,r,i,s,o,l,w){this.#P=e,this.#U=r,this.#F=o,this.#L=t,this.#Z=i,this.#H=l,this.#j=n,this.#$=s,this.#q=w}inverse(){let e=this.#P,t=this.#U,n=this.#F,r=this.#L,i=this.#Z,s=this.#H,o=this.#j,l=this.#$,w=this.#q;return new S(i*w-s*l,s*o-r*w,r*l-i*o,n*l-t*w,e*w-n*o,t*o-e*l,t*s-n*i,n*r-e*s,e*i-t*r)}times(e){let t=this.#P,n=this.#U,r=this.#F,i=this.#L,s=this.#Z,o=this.#H,l=this.#j,w=this.#$,a=this.#q,u=e.#P,f=e.#U,h=e.#F,c=e.#L,d=e.#Z,g=e.#H,m=e.#j,b=e.#$,y=e.#q;return new S(t*u+i*f+l*h,t*c+i*d+l*g,t*m+i*b+l*y,n*u+s*f+w*h,n*c+s*d+w*g,n*m+s*b+w*y,r*u+o*f+a*h,r*c+o*d+a*g,r*m+o*b+a*y)}mapping(e,t){let n=this.#P,r=this.#U,i=this.#F,s=this.#L,o=this.#Z,l=this.#H,w=this.#j,a=this.#$,u=i*e+l*t+this.#q;return[(n*e+s*t+w)/u,(r*e+o*t+a)/u]}}function v(e,t,n,r,i,s,o,l){let w=e-n+i-o,a=t-r+s-l;if(0===w&&0===a)return new S(n-e,i-n,e,r-t,s-r,t,0,0,1);{let u=n-i,f=o-i,h=r-s,c=l-s,d=u*c-f*h,g=(w*c-f*a)/d,m=(u*a-w*h)/d;return new S(n-e+g*n,o-e+m*o,e,r-t+g*r,l-t+m*l,t,g,m,1)}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
