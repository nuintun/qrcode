 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class y{#E;#A;#v;#k;#O;#M;constructor(e,t){let n=0|t.x,r=0|t.y,i=0|e.x,s=0|e.y,o=Math.abs(r-s)>Math.abs(n-i);o&&([i,s,n,r]=[s,i,r,n]);let l=i<n?1:-1;this.#k=o,this.#v=n+l,this.#E=new w(n,r),this.#A=new w(i,s),this.#O=[l,s<r?1:-1],this.#M=[Math.abs(n-i),Math.abs(r-s)]}*points(){let e=this.#v,t=this.#k,{y:n}=this.#E,[r,i]=this.#O,[s,o]=this.#M,{x:w,y:l}=this.#A,a=0|-s/2;for(let u=w,f=l;u!==e;u+=r)if(yield[t?f:u,t?u:f],(a+=o)>0){if(f===n)break;f+=i,a-=s}}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.0.0
