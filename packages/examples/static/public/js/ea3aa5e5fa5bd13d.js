 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class E{#c;#D;#B;#d;constructor(e,t,n,r){let i=new h(e,t),s=C.size(n);this.#c=e,this.#d=t,this.#B=n,this.#D=r,this.#c=i.sample(s,s)}get matrix(){return this.#c}get finder(){return this.#B}get alignment(){return this.#D}get size(){return C.size(this.#B)}get moduleSize(){return C.moduleSize(this.#B)}mapping(e,t){return[e,t]=this.#d.mapping(e,t),new l(e,t)}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class S{#P;#U;#F;#L;#Z;#j;#H;#$;#q;constructor(e,t,n,r,i,s,o,l,w){this.#P=e,this.#U=r,this.#F=o,this.#L=t,this.#Z=i,this.#j=l,this.#H=n,this.#$=s,this.#q=w}buildAdjoint(){let e=this.#P,t=this.#U,n=this.#F,r=this.#L,i=this.#Z,s=this.#j,o=this.#H,l=this.#$,w=this.#q;return new S(i*w-s*l,s*o-r*w,r*l-i*o,n*l-t*w,e*w-n*o,t*o-e*l,t*s-n*i,n*r-e*s,e*i-t*r)}times(e){let t=this.#P,n=this.#U,r=this.#F,i=this.#L,s=this.#Z,o=this.#j,l=this.#H,w=this.#$,a=this.#q,u=e.#P,f=e.#U,h=e.#F,c=e.#L,d=e.#Z,g=e.#j,m=e.#H,b=e.#$,y=e.#q;return new S(t*u+i*f+l*h,t*c+i*d+l*g,t*m+i*b+l*y,n*u+s*f+w*h,n*c+s*d+w*g,n*m+s*b+w*y,r*u+o*f+a*h,r*c+o*d+a*g,r*m+o*b+a*y)}mapping(e,t){let n=this.#P,r=this.#U,i=this.#F,s=this.#L,o=this.#Z,l=this.#j,w=this.#H,a=this.#$,u=i*e+l*t+this.#q;return[(n*e+s*t+w)/u,(r*e+o*t+a)/u]}}function v(e,t,n,r,i,s,o,l){let w=e-n+i-o,a=t-r+s-l;if(0===w&&0===a)return new S(n-e,i-n,e,r-t,s-r,t,0,0,1);{let u=n-i,f=o-i,h=r-s,c=l-s,d=u*c-f*h,g=(w*c-f*a)/d,m=(u*a-w*h)/d;return new S(n-e+g*n,o-e+m*o,e,r-t+g*r,l-t+m*l,t,g,m,1)}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class R{#G;#f;constructor(e){this.#f=e,this.#G=n(e)}get modules(){return this.#G}get ratios(){return this.#f}}let D=new R([1,1,3,1,1]),B=new R([1,1,1,1,1]),P=new R([1,1,1]);function U(e,t){let{length:n}=e,r=n-1;for(let t=0;t<r;t++)e[t]=e[t+1];e[r]=t}function F(e,t,n,r,i){let s=-1,o=t|=0,l=n|=0,w=[0,0,0,0,0],{width:a,height:u}=e,f=i?-1:1,h=()=>{o+=s,l-=s*f},c=()=>e.get(o,l);for(;o>=0&&l>=0&&l<u&&c();)h(),w[2]++;for(;o>=0&&l>=0&&l<u&&!c();)h(),w[1]++;for(;o>=0&&l>=0&&l<u&&w[0]<r&&c();)h(),w[0]++;for(o=t+(s=1),l=n-s*f;o<a&&l>=0&&l<u&&c();)h(),w[2]++;for(;o<a&&l>=0&&l<u&&!c();)h(),w[3]++;for(;o<a&&l>=0&&l<u&&w[4]<r&&c();)h(),w[4]++;return w}function L(e,t){let r=[],i=0|e.length/2;for(let t=0;t<=i;t++){let s=i+t+1;r.push(n(e,i-t,s)/2+n(e,s))}return t-(2*r[0]+n(r,1))/(i+2)}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */let ea=new Map;class eu{#eo;#r;#K;static L=new eu("L",0,1);static M=new eu("M",1,0);static Q=new eu("Q",2,3);static H=new eu("H",3,2);constructor(e,t,n){this.#r=n,this.#eo=e,this.#K=t,ea.set(n,this)}get bits(){return this.#r}get name(){return this.#eo}get level(){return this.#K}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class eg{#el;#m;constructor(e,t){this.#el=e,this.#m=t}get codewords(){return this.#el}get numDataCodewords(){return this.#m}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class em{#ew;#ea;constructor(e,t){let{length:n}=t;if(n<=0)throw Error("polynomial coefficients cannot empty");if(this.#ew=e,n>1&&0===t[0]){let e=1;for(;e<n&&0===t[e];)e++;if(e===n)this.#ea=new Int32Array([0]);else{let r=new Int32Array(n-e);r.set(t.subarray(e)),this.#ea=r}}else this.#ea=t}get coefficients(){return this.#ea}isZero(){return 0===this.#ea[0]}getDegree(){return this.#ea.length-1}getCoefficient(e){let t=this.#ea;return t[t.length-1-e]}evaluate(e){let t;if(0===e)return this.getCoefficient(0);let n=this.#ea;if(1===e){for(let e of(t=0,n))t^=e;return t}[t]=n;let r=this.#ew,{length:i}=n;for(let s=1;s<i;s++)t=r.multiply(e,t)^n[s];return t}multiply(e){let t=this.#ew,n=this.#ea,{length:r}=n;if(e instanceof em){if(this.isZero()||e.isZero())return t.zero;let i=e.#ea,s=i.length,o=new Int32Array(r+s-1);for(let e=0;e<r;e++){let r=n[e];for(let n=0;n<s;n++)o[e+n]^=t.multiply(r,i[n])}return new em(t,o)}if(0===e)return t.zero;if(1===e)return this;let i=new Int32Array(r);for(let s=0;s<r;s++)i[s]=t.multiply(n[s],e);return new em(t,i)}multiplyByMonomial(e,t){let n=this.#ew;if(0===t)return n.zero;let r=this.#ea,{length:i}=r,s=new Int32Array(i+e);for(let e=0;e<i;e++)s[e]=n.multiply(r[e],t);return new em(n,s)}addOrSubtract(e){if(this.isZero())return e;if(e.isZero())return this;let t=e.#ea,n=t.length,r=this.#ea,i=r.length;n<i&&([n,i]=[i,n],[t,r]=[r,t]);let s=n-i,o=new Int32Array(n);o.set(t.subarray(0,s));for(let e=s;e<n;e++)o[e]=r[e-s]^t[e];return new em(this.#ew,o)}divide(e){let t=this.#ew,n=t.zero,r=this,i=e.getCoefficient(e.getDegree()),s=t.invert(i);for(;r.getDegree()>=e.getDegree()&&!r.isZero();){let i=r.getDegree(),o=i-e.getDegree(),l=t.multiply(r.getCoefficient(i),s),w=e.multiplyByMonomial(o,l),a=t.buildPolynomial(o,l);n=n.addOrSubtract(a),r=r.addOrSubtract(w)}return[n,r]}}let eb=new /**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class{#z;#eu;#ef;#eh;#ec;#ed;constructor(e,t,n){let r=1,i=new Int32Array(t);for(let n=0;n<t;n++)i[n]=r,(r*=2)>=t&&(r^=e,r&=t-1);let s=new Int32Array(t);for(let e=0,n=t-1;e<n;e++)s[i[e]]=e;this.#z=t,this.#ec=i,this.#ed=s,this.#eh=n,this.#eu=new em(this,new Int32Array([1])),this.#ef=new em(this,new Int32Array([0]))}get size(){return this.#z}get one(){return this.#eu}get zero(){return this.#ef}get generator(){return this.#eh}exp(e){return this.#ec[e]}log(e){return this.#ed[e]}invert(e){return this.#ec[this.#z-this.#ed[e]-1]}multiply(e,t){if(0===e||0===t)return 0;let n=this.#ed;return this.#ec[(n[e]+n[t])%(this.#z-1)]}buildPolynomial(e,t){if(0===t)return this.#ef;let n=new Int32Array(e+1);return n[0]=t,new em(this,n)}}(285,256,0);class ey{#ew;constructor(e=eb){this.#ew=e}decode(e,t){let n=!0,r=this.#ew,{generator:i}=r,s=new em(r,e),o=new Int32Array(t);for(let e=0;e<t;e++){let l=s.evaluate(r.exp(e+i));o[t-1-e]=l,0!==l&&(n=!1)}if(!n){let n=new em(r,o),[i,s]=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 4.1.0
