 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class w{#s;#o;constructor(e,t){this.#s=e,this.#o=t}get x(){return this.#s}get y(){return this.#o}}function l(e,t){return Math.sqrt(a(e,t))}function a(e,t){let n=e.x-t.x,r=e.y-t.y;return n*n+r*r}function u(e,t,n){let{x:r,y:i}=e,{x:s,y:o}=t,{x:w,y:l}=n;return Math.abs(r*(o-l)+s*(l-i)+w*(i-o))/2}class f extends w{#w;#e;#t;#l;#a;#u=1;#f;#h;static noise(e){return e.#w}static width(e){return e.#e}static height(e){return e.#t}static combined(e){return e.#u}static rect(e){return e.#l}static equals(e,t,n,r,i){let{modules:s}=e.#f,o=e.#h;if(Math.abs(t-e.x)<=o&&Math.abs(n-e.y)<=o){let t=e.#a,n=Math.abs((r+i)/s/2-t);if(n<=1||n<=t)return!0}return!1}static combine(e,t,n,r,i,s){let o=e.#u,w=o+1,l=(e.x*o+t)/w,a=(e.y*o+n)/w,u=(e.#w*o+s)/w,h=(e.#e*o+r)/w,c=(e.#t*o+i)/w,d=new f(e.#f,l,a,h,c,u);return d.#u=w,d}constructor(e,t,n,r,i,s){super(t,n);let{modules:o}=e,w=r/2,l=i/2,a=r/o,u=i/o,f=a/2,h=u/2,c=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e){let{ratios:t}=e;return t[0|t.length/2]/2}(e),d=(a+u)/2;this.#w=s,this.#e=r,this.#t=i,this.#f=e,this.#a=d,this.#l=[t-w+f,n-l+h,t+w-f,n+l-h],this.#h=d*c}get moduleSize(){return this.#a}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class h{#c;#d;constructor(e,t){this.#c=e,this.#d=t}sample(e,t){let n=this.#c,i=n.width,s=this.#d,o=n.height,w=new r(e,t);for(let r=0;r<t;r++)for(let t=0;t<e;t++){let[e,l]=s.mapping(t+.5,r+.5),a=0|e,u=0|l;a>=0&&u>=0&&a<i&&u<o&&n.get(a,u)&&w.set(t,r)}return w}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class y{#E;#A;#k;#v;#M;#O;constructor(e,t){let n=0|t.x,r=0|t.y,i=0|e.x,s=0|e.y,o=Math.abs(r-s)>Math.abs(n-i);o&&([i,s,n,r]=[s,i,r,n]);let l=i<n?1:-1;this.#v=o,this.#k=n+l,this.#E=new w(n,r),this.#A=new w(i,s),this.#M=[l,s<r?1:-1],this.#O=[Math.abs(n-i),Math.abs(r-s)]}*points(){let e=this.#k,t=this.#v,{y:n}=this.#E,[r,i]=this.#M,[s,o]=this.#O,{x:w,y:l}=this.#A,a=0|-s/2;for(let u=w,f=l;u!==e;u+=r)if(yield[t?f:u,t?u:f],(a+=o)>0){if(f===n)break;f+=i,a-=s}}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function p(e,t,n){let r=0,{width:i,height:s}=e,o=(t.x+n.x)/2,a=(t.y+n.y)/2,u=new w(o,a),f=new y(t,u).points();for(let[n,o]of f){if(n<0||o<0||n>=i||o>=s){if(2===r)return l(t,new w(n,o));break}if(1===r==(1===e.get(n,o))){if(2===r)return l(t,new w(n,o));r++}}return NaN}function x(e,t,n){let r=p(e,t,n);if(Number.isNaN(r))return NaN;let{x:i,y:s}=n,{x:o,y:l}=t,a=p(e,t,new w(o-(i-o),l-(s-l)));return Number.isNaN(a)?NaN:r+a-1}function I(e,t,n){let r=new w(0|t.x,0|t.y),i=new w(0|n.x,0|n.y),s=x(e,r,i),o=x(e,i,r);return Number.isNaN(s)?o/7:Number.isNaN(o)?s/7:(s+o)/14}function z(e,t){var n,r,i,s;let o=Math.max((n=f.width(e))>(r=f.width(t))?n/r:r/n,(i=f.height(e))>(s=f.height(t))?i/s:s/i);return o*o}class C{#N;#z;#c;#T;#a;#_;#R;static area(e){let[t,n,r]=e.#_,i=C.bottomRight(e);if(null==e.#N){let s=u(t,n,i),o=u(i,r,t);e.#N=s+o}return e.#N}static moduleSizes(e){if(null==e.#R){let t=e.#c,[n,r,i]=e.#_;e.#R=[I(t,n,r),I(t,n,i)]}return e.#R}static size(t){if(null==t.#z){let n=C.moduleSize(t);t.#z=function(t,n){let[r,i,s]=t,o=l(r,i),w=l(r,s),a=e((o+w)/n/2)+7;switch(3&a){case 0:return a+1;case 2:return a-1;case 3:return Math.min(a+2,177)}return a}(t.#_,n)}return t.#z}static moduleSize(e){return null==e.#a&&(e.#a=n(C.moduleSizes(e))/2),e.#a}static contains(e,t){let n=C.area(e),[r,i,s]=e.#_,o=C.bottomRight(e),w=u(r,i,t),l=u(i,o,t),a=u(o,s,t),f=u(s,r,t);return w+l+a+f-n<1}static bottomRight(e){return null==e.#T&&(e.#T=function(e){let[t,n,r]=e,{x:i,y:s}=t,o=n.x+r.x-i,l=n.y+r.y-s;return new w(o,l)}(e.#_)),e.#T}constructor(e,t){this.#c=e,this.#_=function(e){let t,n,r;let[i,s,o]=e,w=a(i,s)*z(i,s),l=a(i,o)*z(i,o),u=a(s,o)*z(s,o);return u>=w&&u>=l?[t,r,n]=e:l>=u&&l>=w?[r,t,n]=e:[r,n,t]=e,0>function(e,t,n){let{x:r,y:i}=t;return(n.x-r)*(e.y-i)-(n.y-i)*(e.x-r)}(r,t,n)&&([r,n]=[n,r]),[t,n,r]}(t)}get topLeft(){return this.#_[0]}get topRight(){return this.#_[1]}get bottomLeft(){return this.#_[2]}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class E{#B;#U;#F;#Z;#L;#H;#$;#q;#j;constructor(e,t,n,r,i,s,o,w,l){this.#B=e,this.#U=r,this.#F=o,this.#Z=t,this.#L=i,this.#H=w,this.#$=n,this.#q=s,this.#j=l}buildAdjoint(){let e=this.#B,t=this.#U,n=this.#F,r=this.#Z,i=this.#L,s=this.#H,o=this.#$,w=this.#q,l=this.#j;return new E(i*l-s*w,s*o-r*l,r*w-i*o,n*w-t*l,e*l-n*o,t*o-e*w,t*s-n*i,n*r-e*s,e*i-t*r)}times(e){let t=this.#B,n=this.#U,r=this.#F,i=this.#Z,s=this.#L,o=this.#H,w=this.#$,l=this.#q,a=this.#j,u=e.#B,f=e.#U,h=e.#F,c=e.#Z,d=e.#L,g=e.#H,m=e.#$,b=e.#q,y=e.#j;return new E(t*u+i*f+w*h,t*c+i*d+w*g,t*m+i*b+w*y,n*u+s*f+l*h,n*c+s*d+l*g,n*m+s*b+l*y,r*u+o*f+a*h,r*c+o*d+a*g,r*m+o*b+a*y)}mapping(e,t){let n=this.#B,r=this.#U,i=this.#F,s=this.#Z,o=this.#L,w=this.#H,l=this.#$,a=this.#q,u=this.#j,f=i*e+w*t+u;return[(n*e+s*t+l)/f,(r*e+o*t+a)/f]}}function A(e,t,n,r,i,s,o,w){let l=e-n+i-o,a=t-r+s-w;if(0===l&&0===a)return new E(n-e,i-n,e,r-t,s-r,t,0,0,1);{let u=n-i,f=o-i,h=r-s,c=w-s,d=u*c-f*h,g=(l*c-f*a)/d,m=(u*a-l*h)/d;return new E(n-e+g*n,o-e+m*o,e,r-t+g*r,w-t+m*w,t,g,m,1)}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function k(e,t){let n,r,i,s;let{x:o,y:w}=e.topLeft,{x:l,y:a}=e.topRight,{x:u,y:f}=e.bottomLeft,h=C.size(e)-3.5;return null!=t?(n=t.x,r=t.y,s=i=h-3):(n=l+u-o,r=a+f-w,i=h,s=h),function(e,t,n,r,i,s,o,w,l,a,u,f,h,c,d,g){let m=A(3.5,3.5,n,3.5,i,s,3.5,w).buildAdjoint(),b=A(l,a,u,f,h,c,d,g);return b.times(m)}(0,0,h,0,i,s,0,h,o,w,l,a,n,r,u,f)}function v(e,t){let[n,,r]=f.rect(e);return t>0?r:t<0?n:e.x}function M(e,t){let[,n,,r]=f.rect(e);return t>0?r:t<0?n:e.y}function O(e,t,n,r){let{x:i,y:s}=t,{x:o,y:l}=e,{x:a,y:u}=n,f=a>i?1:a<i?-1:0,h=u>s?1:u<s?-1:0,c=v(t,f),d=M(t,h),g=v(e,f),m=M(e,h);return 0===f||0===h?[new w(g,m),new w(c,d)]:(r?f===h:f!==h)?[new w(o,m),new w(i,d)]:[new w(g,l),new w(c,s)]}function N(e,t,n,r){let i=r+8,s=new y(t,n).points(),o=1,w=e.get(0|t.x,0|t.y);for(let[t,n]of s){let r=e.get(t,n);if(r!==w&&(o++,w=r,o>i))return!1}return o>=r-14-Math.max(2,(r-17)/4)}function T(e,t,n){let{topLeft:r,topRight:i,bottomLeft:s}=t,[o,w]=n?O(r,s,i,!0):O(r,i,s);return N(e,o,w,C.size(t))}function _(e,t,n,r){let[i,s]=t.mapping(r?6.5:7.5,r?7.5:6.5),[o,l]=t.mapping(r?6.5:n-7.5,r?n-7.5:6.5);return N(e,new w(i,s),new w(o,l),n)}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class R{#G;#f;constructor(e){this.#f=e,this.#G=n(e)}get modules(){return this.#G}get ratios(){return this.#f}}let D=new R([1,1,3,1,1]),P=new R([1,1,1,1,1]),B=new R([1,1,1]);function U(e,t){let{length:n}=e,r=n-1;for(let t=0;t<r;t++)e[t]=e[t+1];e[r]=t}function F(e,t,n,r,i){let s=-1,o=t|=0,w=n|=0,l=[0,0,0,0,0],{width:a,height:u}=e,f=i?-1:1,h=()=>{o+=s,w-=s*f},c=()=>e.get(o,w);for(;o>=0&&w>=0&&w<u&&c();)h(),l[2]++;for(;o>=0&&w>=0&&w<u&&!c();)h(),l[1]++;for(;o>=0&&w>=0&&w<u&&l[0]<r&&c();)h(),l[0]++;for(o=t+(s=1),w=n-s*f;o<a&&w>=0&&w<u&&c();)h(),l[2]++;for(;o<a&&w>=0&&w<u&&!c();)h(),l[3]++;for(;o<a&&w>=0&&w<u&&l[4]<r&&c();)h(),l[4]++;return l}function Z(e,t){let r=[],i=0|e.length/2;for(let t=0;t<=i;t++){let s=i+t+1;r.push(n(e,i-t,s)/2+n(e,s))}return t-(2*r[0]+n(r,1))/(i+2)}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */class J{#J;#c;#f;#_=[];constructor(e,t,n){this.#c=e,this.#f=t,this.#J=n}get matrix(){return this.#c}get patterns(){return this.#_}match(e,t,r,i){let s=this.#c,o=this.#f,w=Z(r,e),[l,a]=q(s,w,t,i,o,!0);if(l>=0){let e;if([w,e]=q(s,w,l,i,o),w>=0){let t=F(s,w,l,i),r=F(s,w,l,i,!0);if(this.#J?G(t,o)&&G(r,o):G(t,o)||G(r,o)){let i=function(e){for(var t=arguments.length,r=Array(t>1?t-1:0),i=1;i<t;i++)r[i-1]=arguments[i];let s=0,o=0,{length:w}=r,l=[];for(let t of r){let[r,i]=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e,t){let{ratios:r,modules:i}=t,s=0,{length:o}=r,w=n(e),l=w/i;for(let t=0;t<o;t++)s+=Math.abs(e[t]-r[t]*l);return[s/w,l]}(t,e);s+=r,l.push(i)}let a=n(l),u=a/w;for(let e of l)o+=Math.abs(e-u);return s+o/a}(o,e,a,t,r),s=n(e),u=n(a),h=this.#_,{length:c}=h,d=!1;for(let e=0;e<c;e++){let t=h[e];if(f.equals(t,w,l,s,u)){d=!0,h[e]=f.combine(t,w,l,s,u,i);break}}d||h.push(new f(o,w,l,s,u,i))}}}}}class K extends J{constructor(e,t){super(e,D,t)}*groups(){let t=this.patterns.filter(e=>f.combined(e)>=3&&1.5>=f.noise(e)),{length:n}=t;if(3===n){let e=new C(this.matrix,t),n=C.size(e);n>=21&&n<=177&&(yield e)}else if(n>3){let r=n-2,i=n-1,s=new Map;for(let o=0;o<r;o++){let r=t[o],w=r.moduleSize;if(!s.has(r))for(let a=o+1;a<i;a++){let i=t[a],o=i.moduleSize;if(s.has(r))break;if(!s.has(i)&&j(w,o,.5))for(let u=a+1;u<n;u++){let n=t[u],a=n.moduleSize;if(s.has(r)||s.has(i))break;if(!j(w,a,.5)||!j(o,a,.5))continue;let{matrix:h}=this,c=new C(h,[r,i,n]),d=function(e){let{topLeft:t,topRight:n,bottomLeft:r}=e,{x:i,y:s}=t,o=n.x-i,w=n.y-s,l=r.x-i,a=r.y-s;return Math.acos((o*l+w*a)/Math.sqrt((o*o+w*w)*(l*l+a*a)))}(c);if(d>=H&&d<=$){let[o,w]=C.moduleSizes(c);if(o>=1&&w>=1){let{topLeft:a,topRight:u,bottomLeft:d}=c,g=l(a,u),m=l(a,d),b=e(g/o),y=e(m/w);if(4>=Math.abs(b-y)){let e=C.size(c);e>=21&&e<=177&&!/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e){let{x:t,y:n}=e.topLeft,r=C.size(e),i=1-3/(r-7),s=C.bottomRight(e),[o,w]=C.moduleSizes(e),l=t+(s.x-t)*i,a=n+(s.y-n)*i;return new f(P,l,a,5*o,5*w,0)}(t),o=new Q(e,n),w=C.moduleSize(t),{x:l,y:a}=s,u=Math.ceil(w*i),h=0|Math.max(0,a-u),c=0|Math.max(0,l-u),d=0|Math.min(e.width-1,l+u),g=0|Math.min(e.height-1,a+u);return o.find(c,h,d-c,g-h),o.filter(s,w)}(e,r,t);for(let t of s){let s=k(r,t);if(_(e,s,i)&&_(e,s,i,!0)&&(n=yield new S(e,s,r,t)))break}}else{let t=k(r);_(e,t,i)&&_(e,t,i,!0)&&(n=yield new S(e,t,r))}o=s.next(n)}}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function ef(e,t,n,r){return e.get(t,n)?r<<1|1:r<<1}class eh{#z;#c;constructor(e){let{width:t,height:n}=e;this.#c=e.clone(),this.#z=Math.min(t,n)}readVersion(){let e=this.#z,n=0|(e-17)/4;if(n<1)throw Error("");if(n>=1&&n<=6)return b[n-1];let r=0,i=0,s=e-11,o=this.#c;for(let t=5;t>=0;t--)for(let n=e-9;n>=s;n--)r=ef(o,n,t,r);for(let t=5;t>=0;t--)for(let n=e-9;n>=s;n--)i=ef(o,t,n,i);let w=function(e,n){let r=32,i=0,{length:s}=g;for(let o=0;o<s;o++){let s=g[o];if(e===s||n===s)return b[o+6];let w=t(e^s);w<r&&(r=w,i=o+7),e!==n&&(w=t(n^s))<r&&(r=w,i=o+7)}if(r<=3&&i>=7)return b[i-1];throw Error("unable to decode version")}(r,i);if(w.size>e)throw Error("");return w}readFormatInfo(){let e=0,n=0,r=this.#c,i=this.#z,s=i-7;for(let t=0;t<=8;t++)6!==t&&(e=ef(r,t,8,e));for(let t=7;t>=0;t--)6!==t&&(e=ef(r,8,t,e));for(let e=i-1;e>=s;e--)n=ef(r,8,e,n);for(let e=i-8;e<i;e++)n=ef(r,e,8,n);return function(e,n){let r=32,i=0;for(let[s,o]of ea){if(e===s||n===s)return new eu(o);let w=t(e^s);w<r&&(r=w,i=o),e!==n&&(w=t(n^s))<r&&(r=w,i=o)}if(r<=3)return new eu(i);throw Error("unable to decode format information")}(e,n)}readCodewords(e,t){let n=0,i=0,s=0,o=!0,w=this.#z,l=this.#c,a=e.getECBlocks(t),u=function(e){let{size:t,version:n,alignmentPatterns:i}=e,{length:s}=i,o=new r(t,t),w=s-1;o.setRegion(0,0,9,9),o.setRegion(t-8,0,8,9),o.setRegion(0,t-8,9,8);for(let e=0;e<s;e++){let t=i[e]-2;for(let n=0;n<s;n++)(0!==e||0!==n&&n!==w)&&(e!==w||0!==n)&&o.setRegion(i[n]-2,t,5,5)}return o.setRegion(6,9,1,t-17),o.setRegion(9,6,t-17,1),n>6&&(o.setRegion(t-11,0,3,6),o.setRegion(0,t-11,6,3)),o}(e),f=new Uint8Array(a.numTotalCodewords);for(let e=w-1;e>0;e-=2){6===e&&e--;for(let t=0;t<w;t++){let r=o?w-1-t:t;for(let t=0;t<2;t++){let o=e-t;u.get(o,r)||(n++,s<<=1,l.get(o,r)&&(s|=1),8!==n||(f[i++]=s,n=0,s=0))}}o=!o}if(i!==a.numTotalCodewords)throw Error("byteOffset !== ecBlocks.numTotalCodewords");return f}unmask(e){let t=this.#z,n=this.#c;for(let r=0;r<t;r++)for(let i=0;i<t;i++)(function(e,t,n){let r,i;switch(e){case 0:i=n+t&1;break;case 1:i=1&n;break;case 2:i=t%3;break;case 3:i=(n+t)%3;break;case 4:i=(0|n/2)+(0|t/3)&1;break;case 5:i=(1&(r=n*t))+r%3;break;case 6:i=(1&(r=n*t))+r%3&1;break;case 7:i=n*t%3+(n+t&1)&1;break;default:throw Error(`illegal mask: ${e}`)}return 0===i})(e,i,r)&&n.flip(i,r)}remask(e){this.unmask(e)}mirror(){let e=this.#z,t=this.#c;for(let n=0;n<e;n++)for(let r=n+1;r<e;r++)t.get(n,r)!==t.get(r,n)&&(t.flip(n,r),t.flip(r,n))}}/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function eb(e,t,n){let{mask:r,level:i}=n,s=0,o=0;e.unmask(r);let w=t.getECBlocks(i),l=e.readCodewords(t,i),a=function(e,t,n){let{ecBlocks:r,numTotalCodewords:i,numECCodewordsPerBlock:s}=t.getECBlocks(n);if(e.length!==i)throw Error("failed to get data blocks");let o=[];for(let{count:e,numDataCodewords:t}of r)for(let n=0;n<e;n++){let e=s+t;o.push(new ec(new Uint8Array(e),t))}let{length:w}=o,l=w-1,a=o[0].codewords.length;for(;l>=0;){let e=o[l].codewords.length;if(e===a)break;l--}l++;let u=0,f=a-s;for(let t=0;t<f;t++)for(let n=0;n<w;n++)o[n].codewords[t]=e[u++];for(let t=l;t<w;t++)o[t].codewords[f]=e[u++];let h=o[0].codewords.length;for(let t=f;t<h;t++)for(let n=0;n<w;n++){let r=n<l?t:t+1;o[n].codewords[r]=e[u++]}return o}(l,t,i),u=new Uint8Array(w.numTotalDataCodewords);for(let{codewords:e,numDataCodewords:t}of a){let[n,r]=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e,t){let n=new Int32Array(e),r=e.length-t,i=new em().decode(n,r);return[n,i]}(e,t);u.set(n.subarray(0,t),s),o+=r,s+=t}return[u,o]}class ey{#eg;constructor({decode:e=er}={}){this.#eg=e}decode(e){let t,n,r,i=0,s=!1,o=new eh(e);try{t=o.readVersion(),r=o.readFormatInfo(),[n,i]=eb(o,t,r)}catch{null!=r&&o.remask(r.mask),o.mirror(),s=!0,t=o.readVersion(),r=o.readFormatInfo(),[n,i]=eb(o,t,r)}return new Y(function(e,t,n,r){let i,s,{}=n,o="",w=-1,l=!1,a=!1,u=!1,f=!1,h=new W(e);do switch(i=4>h.available()?ee.TERMINATOR:function(e){let t=X.get(e);if(null!=t)return t;throw Error("illegal mode bits")}(h.read(4))){case ee.TERMINATOR:break;case ee.FNC1_FIRST_POSITION:l=!0;break;case ee.FNC1_SECOND_POSITION:a=!0,w=h.read(8);break;case ee.STRUCTURED_APPEND:if(16>h.available())throw Error("illegal structured append");f={index:h.read(4),count:h.read(4)+1,parity:h.read(8)};break;case ee.ECI:s=/**
 * @module QRCode
 * @package @nuintun/qrcode
 * @license MIT
 * @version 3.3.5
 ...
 * @description A pure JavaScript QRCode encode and decode library.
 * @see https://github.com/nuintun/qrcode#readme
 */function(e){let t=e.read(8);if((128&t)==0)return 127&t;if((192&t)==128){let n=e.read(8);return(63&t)<<8|n}if((224&t)==192){let n=e.read(16);return(31&t)<<16|n}throw Error("")}(h);break;default:if(i===ee.HANZI){let e=h.read(4);if(1!==e)throw Error("illegal hanzi subset")}let c=h.read(i.getCharacterCountBits(t));switch(i){case ee.ALPHANUMERIC:o+=function(e,t,n){let r="";for(;t>1;){if(11>e.available())throw Error("");let n=e.read(11);r+=es.charAt(n/45)+es.charAt(n%45),t-=2}if(1==t){if(6>e.available())throw Error("");r+=es.charAt(e.read(6))}return n?eo(r):r}(h,c,l||a);break;case ee.BYTE:o+=function(e,t,n,r,i){if(e.available()<8*t)throw Error("");let s=new Uint8Array(t),o=null!=i?function(e){let t=et.get(e);if(t)return t;throw Error("illegal charset value")}(i):en.ISO_8859_1;for(let n=0;n<t;n++)s[n]=e.read(8);let w=n(s,o);return r?eo(w):w}(h,c,r,l||a,s);break;case ee.HANZI:o+=function(e,t){if(e.available()<13*t)throw Error("");let n=0,r=new Uint8Array(2*t);for(;t>0;){let i=e.read(13),s=i/96<<8|i%96;s<2560?s+=41377:s+=42657,r[n]=s>>8&255,r[n+1]=255&s,t--,n+=2}return new TextDecoder("gb2312").decode(r)}(h,c);break;case ee.KANJI:o+=function(e,t){if(e.available()<13*t)throw Error("");let n=0,r=new Uint8Array(2*t);for(;t>0;){let i=e.read(13),s=i/192<<8|i%192;s<7936?s+=33088:s+=49472,r[n]=s>>8&255,r[n+1]=255&s,t--,n+=2}return new TextDecoder("shift-jis").decode(r)}(h,c);break;case ee.NUMERIC:o+=function(e,t){let n="";for(;t>=3;){if(10>e.available())throw Error("");let r=e.read(10);if(r>=1e3)throw Error("");n+=ei.charAt(r/100)+ei.charAt(r/10%10)+ei.charAt(r%10),t-=3}if(2===t){if(7>e.available())throw Error("illegal numeric");let t=e.read(7);if(t>=100)throw Error("illegal numeric codeword");n+=ei.charAt(t/10)+ei.charAt(t%10)}else if(1===t){if(4>e.available())throw Error("illegal numeric");let t=e.read(4);if(t>=10)throw Error("illegal numeric codeword");n+=ei.charAt(t)}return n}(h,c);break;default:throw Error("")}}while(i!==ee.TERMINATOR);return l?u=["GS1"]:a&&(u=["AIM",w]),{content:o,codewords:e,structured:f,symbology:`]Q${null!=s?l?4:a?6:2:l?3:a?5:1}`,fnc1:u}}(n,t,r,this.#eg),t,r,i,s)}}function ep(e){return{x:e.x,y:e.y}}function ex(e){return{x:e.x,y:e.y,moduleSize:e.moduleSize}}self.addEventListener("message",async e=>{let{data:t}=e,{uid:n,image:w}=t,{width:l,height:a}=w,u=new OffscreenCanvas(l,a),f=u.getContext("2d");f.drawImage(w,0,0);let h=function(e){let{data:t,width:n,height:r}=e,i=new Uint8Array(n*r);for(let e=0;e<r;e++){let r=e*n;for(let e=0;e<n;e++){let n=r+e,s=4*n,o=t[s],w=t[s+1],l=t[s+2];i[r+e]=.299*o+.587*w+.114*l}}return i}(f.getImageData(0,0,l,a)),c=function(e,t,n){if(e.length!==t*n)throw Error("luminances length must be equals to width * height");return t<40||n<40?function(e,t,n){let i=new r(t,n),s=new Int32Array(32);for(let r=1;r<5;r++){let i=0|4*t/5,o=(0|n*r/5)*t;for(let n=0|t/5;n<i;n++){let t=e[o+n];s[t>>3]++}}let o=function(e){let t=0,n=0,r=0,{length:i}=e;for(let s=0;s<i;s++)e[s]>n&&(t=s,n=e[s]),e[s]>r&&(r=e[s]);let s=0,o=0;for(let n=0;n<i;n++){let r=n-t,i=e[n]*r*r;i>o&&(s=n,o=i)}if(t>s&&([t,s]=[s,t]),s-t<=2)return -1;let w=-1,l=s-1;for(let n=s-1;n>t;n--){let i=n-t,o=i*i*(s-n)*(r-e[n]);o>w&&(l=n,w=o)}return l<<3}(s);if(o>0)for(let r=0;r<n;r++){let n=r*t;for(let s=0;s<t;s++){let t=e[n+s];t<o&&i.set(s,r)}}return i}(e,t,n):function(e,t,n){let w=t-8,l=n-8,a=i(t),u=i(n),f=new r(t,n),h=function(e,t,n){let r=[],s=t-8,w=n-8,l=i(t),a=i(n);for(let n=0;n<a;n++){r[n]=new Int32Array(l);let i=o(n,w);for(let w=0;w<l;w++){let l=0,a=0,u=255,f=o(w,s);for(let n=0,r=i*t+f;n<8;n++,r+=t){for(let t=0;t<8;t++){let n=e[r+t];l+=n,n<u&&(u=n),n>a&&(a=n)}if(a-u>24)for(n++,r+=t;n<8;n++,r+=t)for(let t=0;t<8;t++)l+=e[r+t]}let h=l>>6;if(a-u<=24&&(h=u/2,n>0&&w>0)){let e=(r[n-1][w]+2*r[n][w-1]+r[n-1][w-1])/4;u<e&&(h=e)}r[n][w]=h}}return r}(e,t,n);for(let n=0;n<u;n++){let r=s(n,u-3),i=o(n,l);for(let n=0;n<a;n++){let l=0,u=s(n,a-3),c=o(n,w);for(let e=-2;e<=2;e++){let t=h[r+e];l+=t[u-2]+t[u-1]+t[u]+t[u+1]+t[u+2]}let d=l/25;for(let n=0,r=i*t+c;n<8;n++,r+=t)for(let t=0;t<8;t++)e[r+t]<=d&&f.set(c+t,i+n)}}return f}(e,t,n)}(h,l,a);t.invert&&c.flip();let d=new V({strict:t.strict}),g=d.detect(c),m=[],b=new ey,y=g.next();for(;!y.done;){let e=!1,t=y.value;try{let{size:n,finder:r,alignment:i}=t,s=b.decode(t.matrix),{topLeft:o,topRight:w,bottomLeft:l}=r,a=t.mapping(0,0),u=t.mapping(n,0),f=t.mapping(n,n),h=t.mapping(0,n),c=t.mapping(6.5,6.5),d=t.mapping(n-6.5,6.5),g=t.mapping(6.5,n-6.5);m.push({content:s.content,alignment:i?ex(i):null,finder:[ex(o),ex(w),ex(l)],timing:[ep(c),ep(d),ep(g)],corners:[ep(a),ep(u),ep(f),ep(h)]}),e=!0}catch(e){}y=g.next(e)}m.length>0?self.postMessage({type:"ok",payload:{uid:n,image:w,items:m}},[w]):self.postMessage({type:"error",message:"未发现二维码"})})}();