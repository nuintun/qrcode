  ...
  ***************************************************************************** */
  ...
  function UTF8(str) {
    ...
    for (var i = 0; i < length; i++) {
      ...
      if ((code & 0xfc00) === 0xd800 && i + 1 < length && (str.charCodeAt(i + 1) & 0xfc00) === 0xdc00) {
        // Surrogate Pair
  ...
  function decode$1(data, version, errorCorrectionLevel) {
    ...
    while (stream.available() >= 4) {
      ...
      if (mode === Mode$1.StructuredAppend) {
  ...
  function reorderFinderPatterns(pattern1, pattern2, pattern3) {
    ...
    if (oneThreeDistance >= twoThreeDistance && oneThreeDistance >= oneTwoDistance) {
  ...
  var QRCode$1 = /*#__PURE__*/function () {
    function QRCode() {
