(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function prepareData(version, errorCorrectionLevel, hasEncodeHint, chunks) {
        ...
        for (var i = 0; i < dLength; i++) {
            ...
            // default set encoding UTF-8 when has encode hint
            if (hasEncodeHint && mode === Mode$1.Byte) {
    ...
    var QRCode = /** @class */ (function () {
        ...
        /**
         * @public
         * @method getEncodeHint
         * @returns {boolean}
         */
        QRCode.prototype.getEncodeHint = function () {
            return this.hasEncodeHint;
        };
        /**
         * @public
         * @method setEncodeHint
         * @param {boolean} hasEncodeHint
         */
        QRCode.prototype.setEncodeHint = function (hasEncodeHint) {
            this.hasEncodeHint = hasEncodeHint;
        };
        /**
         * @public
         * @method write
        ...
        QRCode.prototype.make = function () {
            ...
            if (this.autoVersion) {
                for (this.version = 1; this.version <= 40; this.version++) {
                    _a = prepareData(this.version, errorCorrectionLevel, this.hasEncodeHint, chunks), buffer = _a[0], rsBlocks = _a[1], maxDataCount = _a[2];
                    if (buffer.getLengthInBits() <= maxDataCount)
                        break;
                }
            }
            else {
                _b = prepareData(this.version, errorCorrectionLevel, this.hasEncodeHint, chunks), buffer = _b[0], rsBlocks = _b[1], maxDataCount = _b[2];
            }
            // calc module count
