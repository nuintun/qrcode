(function () {
    ...
    ***************************************************************************** */
    ...
    function createStringToBytes(unicodeData, numChars) {
        ...
        var unicodeMap = createUnicodeMap(unicodeData, numChars);
        return function (str) {
            var bytes = [];
            var length = str.length;
            for (var i = 0; i < length; i++) {
