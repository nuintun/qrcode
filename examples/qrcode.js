    ...
    ***************************************************************************** */
    ...
    var Encoder = /*#__PURE__*/ (function () {
        function Encoder(options) {
            ...
            this.chunks = [];
            this.matrix = [];
            var _a = options.version, version = _a === void 0 ? 0 : _a, _b = options.encodingHint, encodingHint = _b === void 0 ? false : _b, _c = options.errorCorrectionLevel, errorCorrectionLevel = _c === void 0 ? exports.ErrorCorrectionLevel.L : _c;
        ...
        var finderPatternGroups = finderPatterns
            ...
            if (index <= MAX_FINDERPATTERNS_TO_SEARCH) {
                var otherPoints = finderPatterns.reduce(function (points, _a, oIndex) {
                    var x = _a.x, y = _a.y, size = _a.size, score = _a.score;
                    if (index !== oIndex) {
                ...
                if (otherPoints.length >= 2) {
                    ...
                    points.push({ points: [point].concat(otherPoints.sort(function (a, b) { return a.score - b.score; }).slice(0, 2)), score: score });
                }
            }
            return points;
        }, [])
    ...
    function binarize(data, width, height, returnInverted, greyscaleWeights, canOverwriteImage) {
        if (greyscaleWeights === void 0) { greyscaleWeights = {
            red: 0.2126,
            green: 0.7152,
            blue: 0.0722,
    ...
    var Decoder = /*#__PURE__*/ (function () {
        ...
        Decoder.prototype.decode = function (data, width, height) {
            ...
            var canOverwriteImage = options.canOverwriteImage, greyScaleWeights = options.greyScaleWeights, _a = options.inversionAttempts, inversionAttempts = _a === void 0 ? 'attemptBoth' : _a;
            ...
            var _b = binarize(data, width, height, invert, greyScaleWeights, canOverwriteImage), binarized = _b.binarized, inverted = _b.inverted;
