...
function Detector(image, width, height) {
  this.image = image;
  this.width = width;
  this.height = height;
  ...
  this.sampleGrid = function(image, width, height, transform, dimension) {
    return GridSampler.sampleGrid(image, width, height, dimension, transform);
  }
  ...
  this.processFinderPatternInfo = function(info) {
    ...
    var bits = this.sampleGrid(this.image, this.width, this.height, transform, dimension);
    var points;
  ...
  this.detect = function() {
    var info = new FinderPatternFinder()
      .findFinderPattern(this.image, this.width, this.height);
