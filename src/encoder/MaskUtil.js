 ...
 */
export function applyMaskPenaltyRule1(matrix) {
 ...
 */
export function applyMaskPenaltyRule2(matrix) {
  var penalty = 0;
 ...
 */
export function applyMaskPenaltyRule3(matrix) {
  var numPenalties = 0;
  var array = matrix.getArray();
  var width = matrix.getWidth();
  var height = matrix.getHeight();
 ...
 */
export function applyMaskPenaltyRule4(matrix) {
  var numDarkCells = 0;
  var array = matrix.getArray();
  var width = matrix.getWidth();
  var height = matrix.getHeight();
 ...
 * pattern conditions.
 */
export function getDataMaskBit(maskPattern, x, y) {
  var intermediate;
  var temp;
